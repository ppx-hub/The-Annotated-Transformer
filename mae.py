# -*- coding: utf-8 -*-
# Time : 2022/9/17 17:19
# Author : Regulus
# FileName: mae.py
# Explain:  Implementation of MAE
# Software: PyCharm
...
class MAE(nn.Module):
    def __init__(
        ...
        *,
        ...
        num_patches, encoder_dim = encoder.pos_embedding.shape[-2:]  # encoder.pos_embedding.shape (n, num_patches, encoder_dim)
    ...
    def forward(self, img):
        device = img.device  # img.shape (8, 3, 256, 256)
